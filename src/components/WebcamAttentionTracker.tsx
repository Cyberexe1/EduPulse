...
const WebcamAttentionTracker: React.FC<WebcamAttentionTrackerProps> = ({ onAttentionChange }) => {
  ...
  return (
    <div className="attention-bg">
      <h1 className="attention-title">EduPulse Attention Tracker Demo</h1>
      <div className="attention-card">
        <video ref={videoRef} autoPlay playsInline muted width={600} height={450} style={{ borderRadius: 8, background: '#000' }} />
